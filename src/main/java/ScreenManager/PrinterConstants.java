  ...
  ,MI    "Y                      MM         MM    Yb          MM     MM     MM
    ...
    public final static TextObject TEAM_LOGO= new TextObject( TextStyle.BOLD+"""
            ...
            /_/ /_/\\___/\\__,_/\\__/ |__/|__/\\__,_/ |___/\\___/ 		 _  __   __  _ _/_ _
            														/_///_'_\\/_'/ // _\\  ...
            													   /
            														"""+TextStyle.RESET, TextObject.Scroll.BLOCK,LIMIT_X,LIMIT_Y);
    ...
    public final static TextObject GAME_OVER= new TextObject("""
            ...
            MM.    `7MMF'  AbmmmqMA     M  YM.P'  MM    MM   Y  ,     MM.      ,MP  `MM A'      MM   Y  ,   MM  YM.  
             `Mb.     MM   A'     VML    M  `YM'   MM    MM     ,M     `Mb.    ,dP'   :MM;       MM     ,M   MM   `Mb.
               `"bmmmdPY .AMA.    .AMMA..JML. `'  .JMML..JMMmmmmMMM       `"bmmd"'      VF      .JMMmmmmMMM .JMML. .JMM."""+TextStyle.RESET,TextObject.Scroll.BLOCK,LIMIT_X,LIMIT_Y).alignTextCenter().alignTextMiddle();
...
/__________)                                        (__________\\"""+TextStyle.RESET,TextObject.Scroll.BLOCK,LIMIT_X,LIMIT_Y).alignTextCenter();
 ...
 Y88b d88P  d88P" "Y88b 888     888      888   o   888   888   8888b   888 
  Y88o88P   888     888 888     888      888  d8b  888   888   88888b  888 
   Y888P    888     888 888     888      888 d888b 888   888   888Y88b 888 
    ...
    888      "Y88888P"   "Y88888P"       888P     Y888 8888888 888    Y888"""+TextStyle.RESET,TextObject.Scroll.BLOCK,LIMIT_X,LIMIT_Y).alignTextCenter().alignTextMiddle();
    public final static TextObject CANDLES= new TextObject(TextStyle.BOLD+"""
                     ...
                     (  |"-.='|            '|"-,-"|
                        ...
                        |     |   |     |   |     |   |     |   |     p   |     |
                        |     |   |     |   |     |   |     |   |     x   |     |
                        '-._,-'   '-._,-'   '-._,-'   '-._,-'   '-._,-"   '-._,-'"""+TextStyle.RESET,TextObject.Scroll.BLOCK,LIMIT_X,LIMIT_Y).alignTextCenter();
    ...
    public final static TextObject CASTLE= new TextObject(TextStyle.BOLD+"""
                ...
                |        |;| |;| |;|         |
                 ...
                 ||:   ||.    |+++++++| .    ||: . |
              __ ||: . ||: ,  |+++++++|.  . _||_   |
                        ____--`~    '--~~__|.    |+++++__|----~    ~`---,              ___"""+TextStyle.RESET,TextObject.Scroll.BLOCK,LIMIT_X,LIMIT_Y).alignTextCenter();
    public final static TextObject TOMB= new TextObject(TextStyle.BOLD+"""
 ,-=-.
/  +  \\
| ~~~ |
|R.I.P|
|_____|"""+TextStyle.RESET,TextObject.Scroll.BLOCK,LIMIT_X,LIMIT_Y);
    public final static TextObject CROIX= new TextObject(TextStyle.BOLD+"""
   _
 _|R|_
|_ I _|
  |P|
  |_|"""+TextStyle.RESET,TextObject.Scroll.BLOCK,LIMIT_X,LIMIT_Y);
...
_/`\\  |-|  /`\\_
( \\  \\_|=|_/  / )
|  \\   )X(   /  |"""+TextStyle.RESET,TextObject.Scroll.BLOCK,20,10).alignTextCenter().alignTextMiddle();
    public final static TextObject WIZARD_IMG= new TextObject(TextStyle.BOLD+"""
              *
              ...
              (|+ | +|)
              \\ /=\\ /
              /`---'\\"""+TextStyle.RESET,TextObject.Scroll.BLOCK,20,10).alignTextCenter().alignTextMiddle();
